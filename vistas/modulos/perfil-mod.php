...
<!--	  		<li>				
		 	 	<a href="facturacion">
		 	 	<i class="fa fa-pencil"></i>	Facturacion</a>
	  		</li>-->
					...
					<form method="post" enctype="multipart/form-data">
						...
						<div class="col-md-3 col-sm-4 col-xs-12 text-center">
							...
							echo '<input type="hidden" value="'.$_SESSION["id"].'" id="idUsuario" name="idUsuario">
							      ...
							      <input type="hidden" value="'.$_SESSION["nombrefiscal"].'" name="nombrefiscalUsuario">
							      <input type="hidden" value="'.$_SESSION["cp"].'" name="cpUsuario" id="cpUsuario">
							      <input type="hidden" value="'.$_SESSION["rfc"].'" name="rfcUsuario" id="rfcUsuario">

							      <input type="hidden" value="'.$_SESSION["regimenfiscal"].'" name="regimenfiscalUsuario" id="regimenfiscalUsuario">
							      <input type="hidden" value="'.$_SESSION["correofact"].'" name="correofactUsuario" id="correofactUsuario">'; 
